/// 任务这一层：本地那套实现怎么读写任务文件、怎么算走过与下一步。
///
/// 「走过」的判定（带后缀的流水投票、重走从头算）是工具箱的算法，
/// 由 `packages/quanttide-work-toolkit/tests/contract/done-voting.json` 两侧钉住；
/// 这里验的是工作室这侧接得对不对：流水记账、闸门、落点、四个动作。
library;
