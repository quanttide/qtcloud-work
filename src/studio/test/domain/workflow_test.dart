...
/// - **模型层**：`WorkflowDetail` / `CriteriaCounts`（`lib/domain/`，界面背后的数据），
...
import 'package:qtcloud_work_studio/application/workflows.dart';
import 'package:qtcloud_work_studio/domain/executor.dart';
